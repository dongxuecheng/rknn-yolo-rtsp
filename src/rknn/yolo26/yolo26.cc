...
int inference_yolo26_model(rknn_app_context_t *app_ctx, image_buffer_t *img, yolo26_object_detect_result_list *od_results, float conf_threshold, float nms_threshold)
{
    int ret;
    ...
    yolo26_post_process(app_ctx, outputs, &letter_box, box_conf_thresh, nms_thresh, od_results);
