...
int inference_yolov5_model(rknn_app_context_t* app_ctx, image_buffer_t* img, yolov5_object_detect_result_list* od_results, float conf_threshold = -1.0f, float nms_threshold = -1.0f);
