...
int MppEncoder::SetupEncCfg()
{
    ...
    case MPP_VIDEO_CodingAVC:
    {
         ...
         * 100 - High profile
         */
        // 设置 H.264 编码的 profile 为 High profile
        mpp_enc_cfg_set_s32(cfg, "h264:profile", 77);
        /*
         ...
         * 50 / 51 / 52         - 4K@30fps
         */
        // 设置 H.264 编码的 level 为 40，对应 1080p@30fps
        mpp_enc_cfg_set_s32(cfg, "h264:level", 30);
         // 启用 CABAC 编码
        mpp_enc_cfg_set_s32(cfg, "h264:cabac_en", 1);
         // 设置 CABAC 编码的 IDC 为 0
